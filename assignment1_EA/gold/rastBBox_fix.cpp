			       ...
			       long r_val )
{
  ...
  */
  ...
  long v0_x, v0_y, v1_x, v1_y, v2_x, v2_y = 0;
  //long v3_x, v3_y = 0;
  long temp_max, temp_min = 0; 
  ...
  temp_max = v0_x > v1_x ? v0_x:v1_x;
  //temp_max = temp_max > v3_x ? temp_max:v3_x;
  ur_x = temp_max > v2_x ? temp_max:v2_x;

  temp_max = v0_y > v1_y ? v0_y:v1_y;
  //temp_max = temp_max > v3_y ? temp_max:v3_y;
  ur_y = temp_max > v2_y ? temp_max:v2_y;

  temp_min = v0_x < v1_x ? v0_x:v1_x;
  //temp_max = temp_min < v3_y ? temp_min:v3_x;
  ll_x = temp_min < v2_x ? temp_min:v2_x;

  temp_min = v0_y < v1_y ? v0_y:v1_y;
  //temp_max = temp_min < v3_y ? temp_min:v3_y;
  ll_y = temp_min < v2_y ? temp_min:v2_y;
...
{ 
 ...
 long v0_x, v0_y, v1_x, v1_y, v2_x, v2_y = 0;
 long v3_x, v3_y = 0;
 long dist0, dist1, dist2, b0, b1, b2 = 0;
  /////
