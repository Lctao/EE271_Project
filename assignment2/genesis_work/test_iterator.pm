...
############################### Module Starts Here ###########################
  ...
  sub to_verilog{ 
	...
	$self->SUPER::to_verilog('/home/lctao13/EE271_proj/assignment2/rtl/test_iterator.vp');
# START USER CODE FROM /home/lctao13/EE271_proj/assignment2/rtl/test_iterator.vp PARSED INTO PACKAGE >>>
# line 1 "/home/lctao13/EE271_proj/assignment2/rtl/test_iterator.vp"
...
print { $self->{OutfileHandle} } '	   next_sample_R14S    =  ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	   next_validSamp_R14H =';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	   next_isQuad_R14H    =';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	   next_state_R14H     =';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	   next_poly_R14S      =';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	   next_color_R14U     = ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	   next_box_R14S       =';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	   next_halt_RnnnnL    = ';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
# <<< END USER CODE FROM /home/lctao13/EE271_proj/assignment2/rtl/test_iterator.vp PARSED INTO PACKAGE
