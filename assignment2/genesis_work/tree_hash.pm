...
############################### Module Starts Here ###########################
  ...
  sub to_verilog{ 
	...
	$self->SUPER::to_verilog('/home/lctao13/EE271_proj/assignment2/rtl/tree_hash.vp');
# START USER CODE FROM /home/lctao13/EE271_proj/assignment2/rtl/tree_hash.vp PARSED INTO PACKAGE >>>
# line 1 "/home/lctao13/EE271_proj/assignment2/rtl/tree_hash.vp"
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
# <<< END USER CODE FROM /home/lctao13/EE271_proj/assignment2/rtl/tree_hash.vp PARSED INTO PACKAGE
