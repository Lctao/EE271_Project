...
############################### Module Starts Here ###########################
  ...
  sub to_verilog{ 
	...
	$self->SUPER::to_verilog('/home/lctao13/EE271_proj/assignment2/rtl/bbox.vp');
# START USER CODE FROM /home/lctao13/EE271_proj/assignment2/rtl/bbox.vp PARSED INTO PACKAGE >>>
# line 1 "/home/lctao13/EE271_proj/assignment2/rtl/bbox.vp"
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // Step 1 Result: LL and UR X, Y Fixed Point Values determined by calculating min/max vertices';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // box_R10S[0][0]: LL X';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // box_R10S[0][1]: LL Y';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // box_R10S[1][0]: UR X';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // box_R10S[1][1]: UR Y';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   logic signed ['; print { $self->{OutfileHandle} } $sig_fig; print { $self->{OutfileHandle} } '-1:0] 	box_R10S[1:0][1:0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // Step 2 Result: LL and UR Rounded Down to SubSample Interval';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   logic signed ['; print { $self->{OutfileHandle} } $sig_fig; print { $self->{OutfileHandle} } '-1:0] 	rounded_box_R10S[1:0][1:0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // Step 3 Result: LL and UR X, Y Fixed Point Values after Clipping';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '   // Step 3 Result: valid if validPoly_R10H && BBox within screen';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   logic 				outvalid_R10H;               // output is valid';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //////// DECLARE OTHER SIGNALS YOU NEED';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   logic [1:0][3:0] comp_sel_R10H;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   logic [3:0] comp_val_R10S;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   logic [2:0] subSample_mask_R10U;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   logic [3:0] validBox_R10H;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //R10 Signals';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   ';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // ********** Step 1:  Determining a Bounding Box ********** ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
    # if( $verts == 4 ) {
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
    if( $verts == 3 ) {
print { $self->{OutfileHandle} } '   // Assign select signals';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   always_comb begin';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      comp_sel_R10H[0][0] = poly_R10S[0][0] < poly_R10S[1][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      comp_sel_R10H[0][1] = poly_R10S[0][1] < poly_R10S[1][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      comp_sel_R10H[0][2] = poly_R10S[0][0] > poly_R10S[1][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      comp_sel_R10H[0][3] = poly_R10S[0][1] > poly_R10S[1][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      comp_sel_R10H[1][0] = comp_val_R10S[0] < poly_R10S[2][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      comp_sel_R10H[1][1] = comp_val_R10S[1] < poly_R10S[2][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      comp_sel_R10H[1][2] = comp_val_R10S[2] > poly_R10S[2][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      comp_sel_R10H[1][3] = comp_val_R10S[3] > poly_R10S[2][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   end';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // Assign mux inout';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   always_comb begin';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '     // Level 1';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '     // UR_X';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      unique case (comp_sel_R10H[0][0])';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '         (1\'b0): comp_val_R10S[0] = poly_R10S[0][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '         (1\'b1): comp_val_R10S[0] = poly_R10S[1][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      endcase';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      unique case (comp_sel_R10H[1][0])';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '         (1\'b0): box_R10S[1][0]   = comp_val_R10S[0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '         (1\'b1): box_R10S[1][0]   = poly_R10S[2][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      endcase';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '     ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      // UR_Y';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      unique case (comp_sel_R10H[0][1])';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '         (1\'b0): comp_val_R10S[1] = poly_R10S[0][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '         (1\'b1): comp_val_R10S[1] = poly_R10S[1][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      endcase';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      unique case (comp_sel_R10H[1][1])';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '         (1\'b0): box_R10S[1][1]   = comp_val_R10S[1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '         (1\'b1): box_R10S[1][1]   = poly_R10S[2][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      endcase';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      // LL_X';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      unique case (comp_sel_R10H[0][2])';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '         (1\'b0): comp_val_R10S[2] = poly_R10S[0][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '         (1\'b1): comp_val_R10S[2] = poly_R10S[1][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      endcase';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      unique case (comp_sel_R10H[1][2])';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '         (1\'b0): box_R10S[0][0]   = comp_val_R10S[2];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '         (1\'b1): box_R10S[0][0]   = poly_R10S[2][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      endcase';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '     ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      // LL_Y';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      unique case (comp_sel_R10H[0][3])';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '         1\'b0: comp_val_R10S[3] = poly_R10S[0][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '         1\'b1: comp_val_R10S[3] = poly_R10S[1][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      endcase';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      unique case (comp_sel_R10H[1][3])';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '         1\'b0: box_R10S[0][1]   = comp_val_R10S[3];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '         1\'b1: box_R10S[0][1]   = poly_R10S[2][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      endcase';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   end';print { $self->{OutfileHandle} } "\n"; 
    }  
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // ***************** End of Step 1 *********************';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // ********** Step 2:  Round Values to Subsample Interval **********';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '   // Convert MSAA signal to mask ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   always_comb begin';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      unique case (subSample_RnnnnU)';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '         (4\'b0001): subSample_mask_R10U = 3\'b111;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '         (4\'b0010): subSample_mask_R10U = 3\'b110;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '         (4\'b0100): subSample_mask_R10U = 3\'b100;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '         (4\'b1000): subSample_mask_R10U = 3\'b000;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      endcase ';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '   always_comb begin';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      // Integer Portion of LL and UR Remains the Same ';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      // Use mask to assign middle bits';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '     = box_R10S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $j; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } '-1:'; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } '-3] & subSample_mask_R10U;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      // All bits of fractional portion below 4 bits are 0';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      rounded_box_R10S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $j; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } '-4:0] = '; print { $self->{OutfileHandle} } $radix-3; print { $self->{OutfileHandle} } '\'b0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   end // always_comb';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
   		}
    }
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // ********** Step 3:  Clipping or Rejection ********** ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '   // outvalid_R10H high if validPoly_R10H && BBox is valid';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   always_comb begin';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      //////// PLACE YOUR CODE HERE';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      //////// ASSIGN "out_box_R10S" and "outvalid_R10H"';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      // Clip rounded box to bounding box';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      out_box_R10S[1][0] = (rounded_box_R10S[1][0] > screen_RnnnnS[0]) ? ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '                           screen_RnnnnS[0] : rounded_box_R10S[1][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      out_box_R10S[1][1] = (rounded_box_R10S[1][1] > screen_RnnnnS[1]) ? ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '                           screen_RnnnnS[1] : rounded_box_R10S[1][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      out_box_R10S[0][0] = (rounded_box_R10S[0][0] < 0) ? ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '                           0 : rounded_box_R10S[0][0]; ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      out_box_R10S[0][1] = (rounded_box_R10S[0][1] < 0) ? ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '                           0 : rounded_box_R10S[0][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      // Check for valid bounding box';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      validBox_R10H[0] = (rounded_box_R10S[1][0] >= 0);';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      validBox_R10H[1] = (rounded_box_R10S[1][1] >= 0);';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      validBox_R10H[2] = (rounded_box_R10S[0][0] <= screen_RnnnnS[0]);';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      validBox_R10H[3] = (rounded_box_R10S[0][1] <= screen_RnnnnS[1]);';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      outvalid_R10H = validPoly_R10H & (&validBox_R10H);';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   end';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // ***************** End of Step 3 *********************';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   ';print { $self->{OutfileHandle} } "\n"; 
...
# <<< END USER CODE FROM /home/lctao13/EE271_proj/assignment2/rtl/bbox.vp PARSED INTO PACKAGE
