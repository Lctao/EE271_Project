...
############################### Module Starts Here ###########################
  ...
  sub to_verilog{ 
	...
	$self->SUPER::to_verilog('/home/lctao13/EE271_proj/assignment2/rtl/sampletest.vp');
# START USER CODE FROM /home/lctao13/EE271_proj/assignment2/rtl/sampletest.vp PARSED INTO PACKAGE >>>
# line 1 "/home/lctao13/EE271_proj/assignment2/rtl/sampletest.vp"
...
print { $self->{OutfileHandle} } '      poly_shift_R16S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $j; print { $self->{OutfileHandle} } '] = ';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   always_comb begin';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '     // assign edge_R16S';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   end';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //// (3) Calculate distance x_1 * y_2 - x_2 * y_1';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   always_comb begin';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '     // assign dist_lg_R16S';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   end   ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //// (4) Check distance and assign hit_valid_R16H.';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   always_comb begin';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '     // assign hit_valid_R16H';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   end   ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
# <<< END USER CODE FROM /home/lctao13/EE271_proj/assignment2/rtl/sampletest.vp PARSED INTO PACKAGE
